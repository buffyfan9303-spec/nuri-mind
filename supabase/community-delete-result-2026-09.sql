-- ════════════════════════════════════════════════════════════════
--  커뮤니티 삭제 RPC가 '실제로 지웠는지'를 돌려준다 (2026-09-25) — ✅ 라이브 적용 완료(마이그레이션 community_delete_result_2026_09)
--  확인: 반환 boolean, anon 실행, owner_hash 비교 유지, 틀린 비밀 호출 → false·글 3건 그대로
