      ...
      <main className="mx-auto max-w-md px-5">
        ...
        >
          <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-[28px] bg-mind-50 shadow-card">
            <span className="floaty text-[52px]">{a.emoji}</span>
          </div>
          ...
          <p className="mx-auto mt-2.5 max-w-[19rem] break-keep text-[14.5px] font-medium leading-relaxed text-ink-sub">{l(a.intro)}</p>
        </motion.div>
              ...
              >
                <Card className="!p-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <h2 className="break-keep text-[17px] font-extrabold leading-snug tracking-tight">{l(s.h)}</h2>
                  </div>
                  {s.key && (
                  ...
                  {s.tip && (
                    <div className="mt-3 flex items-start gap-2 rounded-2xl bg-amber-50 px-3.5 py-2.5">
                      ...
                      <p className="break-keep text-[13.5px] font-bold leading-relaxed text-amber-700">
        ...
        <div className="mt-4 rounded-3xl bg-gradient-to-br from-mind-100 to-mind-50 px-5 py-5 text-center">
          <div className="sparkle text-[26px]">🌟</div>
          <p className="mt-1.5 break-keep text-[15px] font-extrabold leading-relaxed text-mind-700">“{l(a.close)}”</p>
        </div>
        ...
        <motion.button
          ...
          className={`mt-4 w-full rounded-2xl py-3.5 text-[15.5px] font-extrabold transition-colors ${
