      ...
      <div className="bg-dots min-h-dvh pb-36">
        ...
        <main className="mx-auto max-w-md px-5">
          ...
          >
            ...
            <p className="mt-2 break-keep text-[13px] font-bold leading-relaxed text-white/90">
              {l({
          ...
          {!showPaywall ? (
            ...
            <>
              ...
              <p className="mt-4 break-keep px-2 text-center text-[12px] font-bold leading-relaxed text-ink-faint">
                {l({
    ...
    <div className="bg-dots min-h-dvh pb-36">
      ...
      <main className="mx-auto max-w-md px-5">
              ...
              <div className="mt-2.5 space-y-1">
                {f.tasks.map((tk) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`mt-0.5 grid h-[22px] w-[22px] shrink-0 place-items-center rounded-md border-2 text-[13px] font-bold leading-none transition-colors ${
                      ...
                      <span className="min-w-0 flex-1">
                        ...
                        <span className="mt-0.5 inline-block rounded-full bg-surface2 px-2 py-0.5 text-[11px] font-extrabold text-ink-faint">
                          {tk.cadence === 'daily'
        ...
        <Card className="mt-3.5 !p-5">
          ...
          <p className="mt-2.5 text-[11px] font-bold text-ink-faint">
        ...
        <button
          ...
          className="mx-auto mt-5 block text-[12px] font-extrabold text-ink-faint"
        >
