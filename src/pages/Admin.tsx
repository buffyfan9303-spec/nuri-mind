      ...
      <main className="mx-auto max-w-md px-4 pt-4">
                  ...
                  <motion.ul initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-2 space-y-1.5">
                    {sv.questions.map((q, i) => (
                      <li key={q.id} className="rounded-xl bg-surface2 px-3 py-2 text-[12px] font-bold leading-relaxed">
                        ...
                        <span className="ml-1.5 text-[11px] font-extrabold text-ink-faint">
          ...
          <div className="space-y-3">
            ...
            {openReports.map((rp) => (
              <Card key={rp.id} className="!p-4">
                ...
                <p className="mt-2 rounded-xl bg-surface2 px-3 py-2 text-[13px] font-bold leading-relaxed text-ink break-keep line-clamp-4">
                  {rp.excerpt}
                </p>
                <div className="mt-3 grid grid-cols-2 gap-2">
        ...
        {tab === 'stats' && (
          ...
          <div className="mt-3 rounded-2xl bg-white/10 p-4">
            ...
            {aiHealth.map((h) => (
              <div key={h.fn} className="mt-2 rounded-xl bg-black/20 p-3">
                <p className="text-[12px] font-extrabold text-white">{h.fn}</p>
          ...
          <div className="mt-3 rounded-2xl bg-white/10 p-4">
            ...
            {opMsg && <p className="mt-2.5 text-[12px] font-bold text-white/90">{opMsg}</p>}
