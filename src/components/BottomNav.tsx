  ...
  return (
    <>
      ...
      <nav className="safe-bottom pointer-events-none fixed inset-x-0 bottom-0 z-40">
        <div className="glass pointer-events-auto mx-auto mb-1 flex max-w-[380px] items-center justify-around rounded-[26px] border border-line bg-surface/85 px-1.5 py-1.5 shadow-pop">
          {TABS.map((tab) => {
